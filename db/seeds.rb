...
Message.create(album_id: Album.first.id, content: Faker::Quote.famous_last_words, mood: "happy", user_id: User.all.sample.id)
Message.create(album_id: Album.first.id, content: Faker::Quote.famous_last_words, mood: "sad", user_id: User.all.sample.id)
Message.create(album_id: Album.first.id, content: Faker::Quote.matz, mood: "happy", user_id: User.all.sample.id)
Message.create(album_id: Album.first.id, content: Faker::Quote.famous_last_words, mood: "angry", user_id: User.all.sample.id)
Message.create(album_id: Album.first.id, content: Faker::Quote.matz, mood: "sad", user_id: User.all.sample.id)



# More Messages
Message.create(album_id: Album.all.sample.id, content: "The melodies are relatively hollow, and lack variety.", mood: "sad", user_id: User.all.sample.id)
Message.create(album_id: Album.all.sample.id, content: "Easily their greatest albums, and one of the greatest albums of all time.", mood: "angry", user_id: User.all.sample.id)
Message.create(album_id: Album.all.sample.id, content: Faker::Quote.matz, mood: "happy", user_id: User.all.sample.id)
Message.create(album_id: Album.all.sample.id, content: Faker::Quote.jack_handey, mood: "sad", user_id: User.all.sample.id)
Message.create(album_id: Album.all.sample.id, content: "Although nonsensical, the lyrics convey the feeling of the album wonderfully.", mood: "happy", user_id: User.all.sample.id)
Message.create(album_id: Album.all.sample.id, content: "An intense feeling of strength and a craving for more follows the astounding piece.", mood: "sad", user_id: User.all.sample.id)
Message.create(album_id: Album.all.sample.id, content: "Happiness, but then a bit of depression, seeing as that music like this just doesn’t exist anymore.", mood: "sad", user_id: User.all.sample.id)
Message.create(album_id: Album.all.sample.id, content: "This is basically a bunch of beeps, clicks and bells that repeat over and over again until the listener needs to be admitted to a mental hospital.", mood: "angry", user_id: User.all.sample.id)
Message.create(album_id: Album.all.sample.id, content: "Disgust. I almost felt like throwing up after listening to this.", mood: "angry", user_id: User.all.sample.id)
Message.create(album_id: Album.all.sample.id, content: "The melodies are relatively hollow, and lack variety.", mood: "sad", user_id: User.all.sample.id)
Message.create(album_id: Album.all.sample.id, content: "Easily their greatest albums, and one of the greatest albums of all time.", mood: "angry", user_id: User.all.sample.id)
Message.create(album_id: Album.all.sample.id, content: Faker::Quote.matz, mood: "happy", user_id: User.all.sample.id)
Message.create(album_id: Album.all.sample.id, content: Faker::Quote.jack_handey, mood: "sad", user_id: User.all.sample.id)
